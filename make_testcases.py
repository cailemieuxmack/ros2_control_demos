...
for i in range(len(miss_cases)):
    os.system(f"cp results/state_{miss_cases[i]} {REPAIR_PATH}/docker/test/n{i}")
    os.system(f"cp results/actuation_{miss_cases[i]} {REPAIR_PATH}/docker/test/output.n{i}")
